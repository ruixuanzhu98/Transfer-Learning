...
df_record.to_csv('/home/zhur/test_y_axis.csv',index=True)
...
loaded_data=[]
for i in gene_name:
    image_dataset= {'train': CustomDataset_2('/home/zhur/retraining2/{}_train_file_info.csv'.format(i),transform=data_transforms_2),  \
                    'validation': CustomDataset_2('/home/zhur/retraining2/{}_val_file_info.csv'.format(i),transform=data_transforms_2)
    }
    ...
    for j in range(num_class):
        ...
        for phase in ['train','validation']:
            ...
            if phase=='train':
                ...
                with open('/home/zhur/f1_train_data.txt', 'a') as f:
                ...
                with open('/home/zhur/f1_val_data.txt', 'a') as f:

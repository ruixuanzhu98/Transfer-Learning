...
from retraining_x_slice import num_class, gene_name
...
test_img=app_image.crop((6001,0,app_size[0],app_size[1]))
...
def model_load(num_class):
    ...
    model=dp(model,device_ids=[6,3,5,4,2])
...
for j in range(num_class):
    ...
    plt.savefig('/home/zhur/test_map_x_slice/{}.jpg'.format(gene_name[j]))
